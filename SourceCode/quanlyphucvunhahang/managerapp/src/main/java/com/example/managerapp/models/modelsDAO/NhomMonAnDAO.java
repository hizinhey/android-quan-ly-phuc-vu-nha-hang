...
public class NhomMonAnDAO {
    private static final String FLAG = "NhomMonAn";
    private static final String SIMPLE = "NA";
    ...
    public int set(final NhomMonAnEntity record) throws InterruptedException {
    ...
    public int change(NhomMonAnEntity newRecord) throws InterruptedException {
