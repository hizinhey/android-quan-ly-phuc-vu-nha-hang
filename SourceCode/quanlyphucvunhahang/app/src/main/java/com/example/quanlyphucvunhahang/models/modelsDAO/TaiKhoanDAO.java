...
public class TaiKhoanDAO {
    private static final String FLAG = "TaiKhoan";
    private static final String SIMPLE = "TK";
    ...
    public int set(final TaiKhoanEntity record) throws InterruptedException {
    ...
    public int change(TaiKhoanEntity newRecord) throws InterruptedException {
