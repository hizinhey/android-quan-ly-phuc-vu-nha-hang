...
public class BuaAnDAO {
    ...
    public int set(final BuaAnEntity record) throws InterruptedException {
    ...
    public int change(BuaAnEntity newRecord) throws InterruptedException {
